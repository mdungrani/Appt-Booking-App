...
function PatientView() {
    ...
    // const fullAddress = `${patient.clinic_address}, ${patient.city}, ${doctor.state}, ${doctor.zipcode}`;
                            ...
                            <div class="card w-full card-border bg-white p-5 rounded-2xl text-md">
                                <div class="card-body">
                                    <div className="flex items-center">
                                        <p className="flex-1 font-bold">Scheduled Appointments</p>
                                        <div>
                                            {/* <p className="rounded-full bg-green-400 text-white py-3 px-5">{patient.appointments.length}</p> */}
                                        </div>
                                    </div>
                                    <div className="">
                                            ...
                                            <div className="card bg-gray-100 rounded-xl px-6 py-3 mt-5">
                                                <div className="flex items-center text-gray-900 whitespace-nowrap">
                                                    <img
                                                        ...
                                                        src={`http://localhost:8000${appt.doctor_profile_image}`}
                                                        alt="Patient Image"
                                                    />
                                                    <div className="ps-3">
                                                        <div className="text-md">Dr. {appt.doctor_name}</div>
                            ...
                            <div className="flex">
                                <div className="pr-5">
                                    <img
                                        ...
                                        src={`http://localhost:8000${patient.profile_image}`}
                                        alt="Doctor"
                                    />
                                </div>
                                <div className="">
                                    <div>
                                        <p class="font-bold text-md">{patient.first_name} {patient.last_name}</p>
                                        <p className="text-sm text-gray-4/00">{patient.clinic_name}</p>
                                    </div>
                                    <div className="flex gap-4 pt-5">
                                        ...
                                        <div className="flex items-center bg-brandGreen-default px-4 rounded-full py-1">
                                            ...
                                            <p className="text-sm font-medium pl-2">{patient.gender == "F" ? "Female" : "Male"}</p>
                                        </div>
                                    </div>
                                </div>
